          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <form className="flex flex-col sm:flex-row gap-4 w-full max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
              <input 
                ...
                className="flex-1 px-8 py-4 rounded-full bg-white/10 border border-white/20 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-red-600 transition-all font-medium"
              />
              <button className="px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-full transition-all flex items-center justify-center gap-2 group">
                SUBSCRIBE
